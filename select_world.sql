-- 1. Read the notes about this table. Observe the result of running this SQL command to show 
-- the name, continent and population of all countries.

SELECT name, continent, population FROM world;

-- 2. How to use WHERE to filter records. Show the name for the countries that have a 
